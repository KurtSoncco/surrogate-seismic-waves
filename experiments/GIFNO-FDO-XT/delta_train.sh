#!/bin/bash
# GIFNO-FDO-XT training on NCSA Delta.
#
...
#SBATCH --output=xt_train.o%j
#SBATCH --error=xt_train.e%j
...
export GIFNO_MODEL_DIR="${GIFNO_MODEL_DIR:-${GIFNO_TF_DIR}/models/fdo_xt}"
export GIFNO_RESULTS_DIR="${GIFNO_RESULTS_DIR:-${GIFNO_TF_DIR}/results/fdo_xt}"
...
echo "=== GIFNO-FDO-XT training on Delta ==="
echo "WANDB_PROJECT=gifno_fdo_xt"
