#!/bin/bash
# GIFNO-FDO-XT-LOGLO-POD training on NCSA Delta.
#
...
#SBATCH --job-name=loglo_pod_train
...
echo "=== GIFNO-FDO-XT-LOGLO-POD training on Delta ==="
...
echo "Model:  LATENT=${GIFNO_LATENT_CHANNELS} POD_MODES=${GIFNO_POD_NUM_MODES} RADIAL_LOSS=${GIFNO_LOSS_RADIAL_WEIGHT}"
echo "Args:     $*"
echo "=============================================="
