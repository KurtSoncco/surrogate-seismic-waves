...
Example:
  ...
  uv run python seed_robustness/peak_f0_robustness.py --split test
  uv run python seed_robustness/peak_f0_robustness.py --split all   # full corpus
"""
...
DEFAULT_OUT_ROOT = (
    Path.home() / "surrogate-seismic-waves" / "checkpoints" / "peak_f0_robustness"
)
