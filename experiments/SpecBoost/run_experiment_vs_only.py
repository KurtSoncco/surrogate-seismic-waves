# run_experiment_vs_only.py
"""
Experiment 1: Can the residual be predicted from the Vs Profile ONLY?
"""
...
from experiment_models import SimplifiedVsOnlyModel
...
logger.name = "SpecBoost_Experiment_VsOnly"


class VsOnlyResidualDataset(Dataset):
    """Dataset that provides only the Vs Profile as input and the normalized residual as target."""
    ...
    def __getitem__(self, idx):
        ...
        return vs_profile, normalized_residual
...
def main():
    ...
    train_exp_dataset = VsOnlyResidualDataset(
        train_dataset, train_preds_a, residual_mean, residual_std
    )
    val_exp_dataset = VsOnlyResidualDataset(
    ...
    run_experiment_training_loop(
        ...
        experiment_name="VsProfile_Only",
    )
