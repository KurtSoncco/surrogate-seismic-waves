#!/bin/bash
# GIFNO-FDO-XT-HFS training on NCSA Delta.
#
...
#SBATCH --output=hfs_train.o%j
#SBATCH --error=hfs_train.e%j
...
export GIFNO_MODEL_DIR="${GIFNO_MODEL_DIR:-${GIFNO_TF_DIR}/models/fdo_xt_hfs}"
export GIFNO_RESULTS_DIR="${GIFNO_RESULTS_DIR:-${GIFNO_TF_DIR}/results/fdo_xt_hfs}"
...
echo "=== GIFNO-FDO-XT-HFS training on Delta ==="
echo "WANDB_PROJECT=gifno_fdo_xt_hfs"
