...
class MetricsCalculator:
    ...
    def calculate_all_metrics(
        ...
        metrics.update(
            self.calculate_regression_metrics(predictions, targets, sample_weights)
        )
        ...
        if frequency_data is not None:
            metrics.update(
                self.calculate_frequency_metrics(pred_np, target_np, frequency_data)
            )
...
class ModelEvaluator:
    ...
    def cross_validate_model(
        ...
        return {"fold_results": fold_results, "aggregated_metrics": aggregated_metrics}
