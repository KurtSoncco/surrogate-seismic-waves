#!/usr/bin/env python3
"""
Evaluate a saved GIFNO-FDO-LG checkpoint on the test split and write analysis artifacts.

Default output: experiments/GIFNO-FDO-LG/analysis/<run_name>/
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate LG checkpoint on test set")
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=None,
    ...
    parser.add_argument(
        ...
        type=str,
        default="lg_phase1",
        help="Subfolder under experiments/GIFNO-FDO-LG/analysis/",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
